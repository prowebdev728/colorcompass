<div class="news">
	...
	<div class="row small-up-1 medium-up-3">
		<div class="column">
			The Chase winners were:
			<ol>
				<li>Dan Tougas -  Winnipeg</li>
				<li>Danny Felske - Winnipeg</li>
				<li>Garry Hopp -  Langley</li>
				<li>Jay Patel -  Vancouver</li>
			</ol>
		</div>
		<div class="column">
			The White &amp; Peters winners were:
			<ol>
				<li>Lawrence Bradley - Langley</li>
				<li>John Johnston - Kelowna</li>
				<li>Peter Lui - Vancouver</li>
				<li>Dwain Black - Kelowna</li>
			</ol>
		</div>
		<div class="column">
			The Carlson and Rocky Mountain winners were:
			<ol>
				<li>Adam Pacholko - Regina</li>
				<li>Jason Hall - Calgary</li>
				<li>Brent Campbell - Edmonton</li>
			</ol>
		</div>
	</div>
	<p>Congratulations to the winners and the sales teams on a successful promotion!<br>The winning customer draw will take place on Wednesday February 8th. </p>
</div>